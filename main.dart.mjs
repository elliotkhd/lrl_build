...
_1518: x0 => x0.length,
_1604: x0 => ({audio: x0}),
_1605: (x0,x1) => x0.getUserMedia(x1),
_1606: x0 => x0.getAudioTracks(),
_1607: x0 => x0.stop(),
_1608: x0 => ({video: x0}),
_1609: x0 => x0.getVideoTracks(),
_1610: x0 => x0.stop(),
_1611: () => globalThis.Notification.requestPermission(),
_1612: f => finalizeWrapper(f,x0 => dartInstance.exports._1612(f,x0)),
_1613: f => finalizeWrapper(f,x0 => dartInstance.exports._1613(f,x0)),
_1614: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
_1615: (x0,x1) => x0.matchMedia(x1),
...
_1663: v => stringToDartString(v.toString()),
_1664: (d, digits) => stringToDartString(d.toFixed(digits)),
_1668: o => new WeakRef(o),
_1669: r => r.deref(),
_1674: Date.now,
...
_1687: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1688: s => printToConsole(stringFromDartString(s)),
...
_1717: x0 => x0.abort(),
_1718: x0 => x0.getAllResponseHeaders(),
_1726: f => finalizeWrapper(f,x0 => dartInstance.exports._1726(f,x0)),
_1727: f => finalizeWrapper(f,x0 => dartInstance.exports._1727(f,x0)),
_1728: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1729: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1747: (a, i) => a.push(i),
_1751: a => a.pop(),
_1752: (a, i) => a.splice(i, 1),
_1754: (a, s) => a.join(s),
_1755: (a, s, e) => a.slice(s, e),
_1757: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1758: a => a.length,
_1760: (a, i) => a[i],
_1761: (a, i, v) => a[i] = v,
_1763: a => a.join(''),
...
_1818: x0 => new Uint8Array(x0),
_1819: () => globalThis.crypto,
_1822: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1823: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1825: (s, m) => {
          try {
...
_1870: l => arrayFromDartList(Uint8Array, l),
...
_1880: stringFromDartString,
_1881: stringToDartString,
_1882: () => ({}),
_1883: () => [],
_1884: l => new Array(l),
_1885: () => globalThis,
...
_1916: () => globalThis.window,
_1937: x0 => x0.matches,
_1941: x0 => x0.platform,
_1946: x0 => x0.navigator,
_1994: (x0,x1) => x0.withCredentials = x1,
_1997: x0 => x0.responseURL,
_1998: x0 => x0.status,
_1999: x0 => x0.statusText,
_2000: (x0,x1) => x0.responseType = x1,
_2002: x0 => x0.response,
_3759: () => globalThis.window,
_3840: x0 => x0.navigator,
_4306: x0 => x0.geolocation,
_4309: x0 => x0.mediaDevices,
_4311: x0 => x0.permissions,
_10676: x0 => x0.active
    };
