...
_1623: x0 => x0.getAudioTracks(),
_1624: x0 => x0.stop(),
_1625: x0 => ({video: x0}),
_1626: x0 => x0.getVideoTracks(),
_1627: x0 => x0.stop(),
_1628: () => globalThis.Notification.requestPermission(),
_1629: f => finalizeWrapper(f,x0 => dartInstance.exports._1629(f,x0)),
_1630: f => finalizeWrapper(f,x0 => dartInstance.exports._1630(f,x0)),
_1631: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
_1632: (x0,x1) => x0.matchMedia(x1),
_1643: x0 => new Array(x0),
_1650: f => finalizeWrapper(f,x0 => dartInstance.exports._1650(f,x0)),
_1651: f => finalizeWrapper(f,x0 => dartInstance.exports._1651(f,x0)),
_1677: (decoder, codeUnits) => decoder.decode(codeUnits),
_1678: () => new TextDecoder("utf-8", {fatal: true}),
_1679: () => new TextDecoder("utf-8", {fatal: false}),
_1680: v => stringToDartString(v.toString()),
_1681: (d, digits) => stringToDartString(d.toFixed(digits)),
_1685: o => new WeakRef(o),
_1686: r => r.deref(),
_1691: Date.now,
...
_1731: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1732: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1733: (x0,x1) => x0.send(x1),
_1734: x0 => x0.abort(),
_1735: x0 => x0.getAllResponseHeaders(),
_1742: f => finalizeWrapper(f,x0 => dartInstance.exports._1742(f,x0)),
_1743: f => finalizeWrapper(f,x0 => dartInstance.exports._1743(f,x0)),
_1761: (x0,x1) => x0.key(x1),
_1762: (a, i) => a.push(i),
_1766: a => a.pop(),
...
_1832: (x0,x1) => x0.getRandomValues(x1),
_1833: x0 => new Uint8Array(x0),
_1834: () => globalThis.crypto,
_1837: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1838: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1840: (s, m) => {
          try {
...
_1895: stringFromDartString,
_1896: stringToDartString,
_1897: () => ({}),
_1898: () => [],
_1899: l => new Array(l),
_1900: () => globalThis,
...
_1952: x0 => x0.matches,
_1956: x0 => x0.platform,
_1961: x0 => x0.navigator,
...
_3834: x0 => x0.location,
_3854: x0 => x0.navigator,
_4112: x0 => x0.localStorage,
_4121: x0 => x0.href,
_4320: x0 => x0.geolocation,
_4323: x0 => x0.mediaDevices,
_4325: x0 => x0.permissions,
_4335: x0 => x0.userAgent,
_4553: x0 => x0.length,
_10690: x0 => x0.active
    };
